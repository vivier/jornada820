/*
 * Jornada820 version based on soc_common.c from linux 2.6.11.9
 * $Id: soc_common.c,v 1.2 2005/07/25 09:09:14 fare Exp $
 * Only change: export soc_common_drv_pcmcia_remove
 */
/*======================================================================
