 ...
 */
/* Jornada820 version based on mcp-sa1100.c 1.4 from cvs.handhelds.org
 * $Id: mcp-sa1100.c,v 1.1 2004/06/24 16:58:37 fare Exp $
 */
...
static int mcp_sa1100_probe(struct device *dev)
{
	...
	if (!machine_is_adsbitsy()       && !machine_is_assabet()        &&
	    ...
	    !machine_is_yopy()		 && !machine_is_jornada820())
		return -ENODEV;
