/* Jornada820 version based on psmouse-base.c from linux 2.6.11.9
 * $Id: psmouse-base.c,v 1.4 2005/07/29 10:24:07 fare Exp $
 * Jornada820 builtin trackpad has ID=0x0d.
 * All modifications include a 820 signature comment
 */
/*
 * PS/2 mouse driver
 *
 ...
 */
	...
	if (param[0] != 0x00 && param[0] != 0x03 &&
	    param[0] != 0x04 && param[0] != 0xff &&
            param[0] != 0x0d) /* JORNADA820 MODIFICATION */
		return -1;
