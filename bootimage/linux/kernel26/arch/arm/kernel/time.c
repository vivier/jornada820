 ...
 */
/* Jornada820 version based on time.c 1.10 from cvs.handhelds.org
 * $Id: time.c,v 1.1 2004/06/24 19:57:17 fare Exp $
 */
...
#if !defined(HAVE_SCHED_CLOCK) && !defined(CONFIG_ARCH_PXA)
/*
