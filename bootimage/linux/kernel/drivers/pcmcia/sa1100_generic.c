...
/* Timing value exported through sysctl and /proc/sys */
int timing_increment_ns = 0;
...
static int __init sa1100_pcmcia_driver_init(void)
{
        ...
        printk(__FUNCTION__ ": pcmcia_low_level=%p\n", pcmcia_low_level);
        ...
        for (i = 0; i < sa1100_pcmcia_socket_count; i++) {
                ...
                printk(__FUNCTION__ ": skt=%d skt->virt_io=%lx\n", i, skt->virt_io);
